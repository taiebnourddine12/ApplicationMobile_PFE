...
public class MyAdapterProd extends ArrayAdapter<Model> {
    Context context;
    List<Model> modelArrayList;
    TextView id, date, poste,
    ...
    public MyAdapterProd(@NonNull Context context, ArrayList<Model> modelArrayList) {
        super(context, R.layout.serlistprod, modelArrayList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.serlistprod, null, true);
